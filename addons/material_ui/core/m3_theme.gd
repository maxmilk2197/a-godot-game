...
static var 涟漪长按时长: float = 0.45
## 松开后补完剩余部分的速度基准（「原来的速度」）
static var 涟漪扩散时长: float = 0.225
## 不透明度淡入时长
static var 涟漪淡入时长: float = 0.075
## 松开后的淡出时长
static var 涟漪淡出时长: float = 0.15
